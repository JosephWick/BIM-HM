                           ...
                           double G, double nu)
{
  ...
  double IU1d2 = [](double y1, y2, y3){
    ...
    double s4 = (lambda*epsvkk + 2*G*epsv22p)*J1213d2(y1,y2,y3);
    double s5 = 2*G*epsv23p*(J1212d2(y1,y2,y3) + J1313d2(y1,y2,y3));

    double s6 = (lambda*epsvkk + 2*G*epsv33p)*J1312d2(y1,y2,y3);
  ...
  double IU2d1 = [](double y1, double y2, double y3){
    ...
    double s5 = 2*G*epsv23p*(J2212d1(y1,y2,y3) + J2313d1(y1,y2,y3));

    double s6 = (lambda*epsvkk + 2*G*epsv33p)*(J2312d1(y1,y2,y3));
  ...
  double Omega = [](x){
    return heaviside(x+0.5) - heaviside(x-0.5);
  };
  double S = [](x){
    return Omega(x-0.5);
  };
...
double J2313d1 = [](y1,y2,y3){
  ...
  double u12 = IU1d2(L,T/2,q3+W) - IU1d2(L,-T/2,q3+W) + IU1d2(L,-T/2,q3) - IU1d2(L,T/2,q3)
              -IU1d2(0,T/2,q3+W) + IU1d2(0,-T/2,q3+W) - IU1d2(0,-T/2,q3) + IU1d2(0,T/2,q3);
  double u21 = IU2d1(L,T/2,q3+W) - IU2d1(L,-T/2,q3+W) + IU2d1(L,-T/2,q3) - IU2d1(L,T/2,q3)
