                           ...
                           double G, double nu)
{
  ...
  double J1212d2 = [nu,G, x1,x2,x3](y1,y2,y3){
    ...
    return (1/16)*pow(1-nu,-1)*pow(pi,-1)*((1+8*((-1)+nu)*nu)*pow(lr2,
  ...
  double J2212d1 = [nu,G, x1,x2,x3](y1,y2,y3){
    ...
    return (1/16)*pow(1-nu,-1)*pow(pi,-1)*pow(G,-1)*(pow(x3,2)*pow(pow(x3,2)+pow(x1+
  ...
  double J2213d1 = [nu,G, x1,x2,x3](y1,y2,y3){
    ...
    return (1/16)*pow(1-nu,-1)*pow(pi,-1)*pow(G,-1)*(pow(x2,2)*pow(pow(x2,2)+pow(x1+
        ...
        *y2,2)+pow(x3+y3,2),-1)*pow(pow(x2,4)*y3+4*pow(x2,2)*pow(x3,2)*y3+2*
        ...
        *y2,2)+pow(x3+y3,2))+pow(x1,2)*y3*(pow(x2-y2,2)+(x3+y3)*(2*x3+
        ...
        y2,2)+pow(x3+y3,2),-3/2)*(pow(x2,4)*y3-2*lr2*pw(x2,2)*x3*y3+4*
        ...
        y3-2*lr2*x3*pow(y2,2)*y3+4*pow(x3,2)*pow(y2,2)*y3+poow(y1,2)*pow(y2,2)*y3+(
        ...
        *lr2*pow(y3,4)+5*x3*pow(y3,4)+pow(y3,5)-3*nu*(x3*(pow(x3,2)+pow(y1,2)+pow(x2+(
        ...
        2)+(x3+y3)*(2*x3+y3))))+2*pow(lr2,-1)*(pow(x1-y1,2)+pow(x2+(-1)
        *y2),2),-1)*pow(pow(x2-y2,2)+pow(x3+y3,2),-1)*(-x3*
        ...
        pw(y3,3)+5*x3*pow(y3,4)+pow(y3,5)+pow(x2,4)*(y3-3*nu*(x3+y3)+2*pow(nu,2)*(
        ...
        3*pow(x3,4)+12*pow(x3,3)*y3+3*pow(pow(y2,2)+pow(y3,2),2)+3*pow(x3,2)*(3*pw(y1,2)+2*
  ...
  double J2223d1 = [nu,G, x1,x2,x3](y1,y2,y3) {
    ...
    return (1/16)*pow(1-nu,-1)*pow(pi,-1)*pow(G,-1)*(x1*pow(pow(x1,2)+pow(x2+(
...
double s12::IU2d1(double y1,double y2, double y3, double lambda, double epsvkk, double G,
  ...
  double s1 = (lambda*epsvkk + 2*G*epsv11p)*s12::J1123d2(y1,y2,y3);
  double s2 = 2*G*epsv12p*(s12::J1223d2(y1,y2,y3) + s12::J1113d2(y1,y2,y3));
  double s3 = 2*G*epsv13p*(s12::J1323d2(y1,y2,y3) + s12::J1112d2(y1,y2,y3));

  double s4 = (lambda*epsvkk + 2*G*epsv22p)*s12::J1213d2(y1,y2,y3);
  double s5 = 2*G*epsv23p*(s12::J1212d2(y1,y2,y3) + s12::J1313d2(y1,y2,y3));

  double s6 = (lambda*epsvkk + 2*G*epsv33p)*s12::J1312d2(y1,y2,y3);
...
double s12::IU1d2(double y1,double y2,double y3, double lambda,double epsvkk,double G,
  ...
  doubld s1 = (lambda*epsvkk + 2*G*epsv11p)*s12::J2123d1(y1,y2,y3);
  double s2 = 2*G*epsv12p*(s12::J2223d1(y1,y2,y3) + s12::J2113d1(y1,y2,y3));
  double s3 = 2*G*epsv13p*(s12::J2323d1(y1,y2,y3) + s12::J2112d1(y1,y2,y3));

  double s4 = (lambda*epsvkk + 2*G*epsv22p)*J2213d1(y1,y2,y3);
  double s5 = 2*G*epsv23p*(s12::J2212d1(y1,y2,y3) + s12::J2313d1(y1,y2,y3));

  double s6 = (lambda*epsvkk + 2*G*epsv33p)*(s12::J2312d1(y1,y2,y3));
...
double s12::J1112d2(double y1,double y2,double y3, double nu,double G,
  ...
  double lr1 = s12::r1(y1, y2, y3);
  double lr2 = s12::r2(y1, y2, y3);
...
double s12::J1123d2(double y1,double y2,double y3, double nu,double G,
  ...
  *y3+3*pow(y2,2)*pow(y3,2)+pow(y3,4)+pow(y,2)*(pow(y2,2)+2*pow(y3,2))+po2(x3,2)
...
double J2112d1(double y1,double y2,double y3, double G,double nu,
    double x1, double c2, double x3){
  double lr1 = s12::r1(y1, y2, y3);
  double lr2 = s12::r2(y1, y2, y3);

  return (1/16)*pow(1-nu,-1)*pow(pi,-1)*((1+8*((-1)+nu)*nu)*pow(lr2,-1)
